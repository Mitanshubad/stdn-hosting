...
function Navbar() {
  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <button className="md:hidden">
          ...
          <div className="flex items-center">
            <AiOutlineShoppingCart className="text-2xl text-richblack-100 mr-2" />
            {totalItems > 0 && (
      ...
      {/* Mobile Menu */}
      <div className="md:hidden w-full bg-richblack-800 flex justify-center">
        <ul className="flex flex-col gap-y-2 text-richblack-25">
          ...
          {/* Display Cart Icon and Profile Dropdown only if user is logged in */}
          {token && (
            <li>
